...
// ---------------------------------------------------------------------
public class DocLibUserEOImpl extends OAEntityImpl {
    public static final int USERDOCID = 0;
    public static final int DOCID = 1;
    public static final int USERID = 2;
    public static final int READACCEPTFLAG = 3;
    ...
    public static final int DOCLIBEO = 20;
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = 
                    (OAEntityDefImpl)EntityDefImpl.findDefObject("moiss.oracle.apps.moiss.doclib.schema.server.DocLibUserEO");
        }
        return mDefinitionObject;
    }

    /**Gets the attribute value for UserDocId, using the alias name UserDocId
     */
    public Number getUserDocId() {
        return (Number)getAttributeInternal(USERDOCID);
    }

    /**Sets <code>value</code> as the attribute value for UserDocId
     */
    ...
    /**Gets the attribute value for ReadAcceptFlag, using the alias name ReadAcceptFlag
     */
    public String getReadAcceptFlag() {
        return (String)getAttributeInternal(READACCEPTFLAG);
    }

    /**Sets <code>value</code> as the attribute value for ReadAcceptFlag
     */
    ...
    /**Gets the associated entity DocLibEOImpl
     */
    public DocLibEOImpl getDocLibEO() {
        return (DocLibEOImpl)getAttributeInternal(DOCLIBEO);
    }

    /**Sets <code>value</code> as the associated entity DocLibEOImpl
     */
    public void setDocLibEO(DocLibEOImpl value) {
        setAttributeInternal(DOCLIBEO, value);
    }

    /**Creates a Key object based on given key constituents
     */
    public static Key createPrimaryKey(Number userDocId) {
        return new Key(new Object[]{userDocId});
    }
}
