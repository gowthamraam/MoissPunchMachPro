...
// ---------------------------------------------------------------------
public class MoissPIEOImpl extends OAEntityImpl {
    ...
    public static final int ATTID = 27;
    public static final int PROCDATE = 28;
    public static final int PROCUSERID = 29;
    public static final int PROCYN = 30;
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = 
                    (OAEntityDefImpl)EntityDefImpl.findDefObject("moiss.oracle.apps.fnd.moiss.schema.server.MoissPIEO");
        }
    ...
    protected void setAttrInvokeAccessor(int index, Object value, 
        ...
        case PUNCHINFOID:
            ...
            return;
        case ATTID:
            setAttId((String)value);
            return;
        case PROCDATE:
            setProcDate((String)value);
            return;
        case PROCUSERID:
            setProcUserId((String)value);
            return;
        case PROCYN:
            setProcYn((String)value);
            return;
        default:
    ...
    /**Gets the attribute value for ProcDate, using the alias name ProcDate
     */
    public String getProcDate() {
        return (String)getAttributeInternal(PROCDATE);
    }

    /**Sets <code>value</code> as the attribute value for ProcDate
     */
    public void setProcDate(String value) {
        setAttributeInternal(PROCDATE, value);
    }

    /**Gets the attribute value for ProcUserId, using the alias name ProcUserId
     */
    public String getProcUserId() {
        return (String)getAttributeInternal(PROCUSERID);
    }

    /**Sets <code>value</code> as the attribute value for ProcUserId
     */
    public void setProcUserId(String value) {
        setAttributeInternal(PROCUSERID, value);
    }

    /**Gets the attribute value for ProcYn, using the alias name ProcYn
     */
    public String getProcYn() {
        return (String)getAttributeInternal(PROCYN);
    }

    /**Sets <code>value</code> as the attribute value for ProcYn
     */
    public void setProcYn(String value) {
        setAttributeInternal(PROCYN, value);
    }
